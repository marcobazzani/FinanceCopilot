...
void main() {
  ...
  group('getFirstBuyDate — valueDate convention', () {
    test('returns the earliest valueDate, not operationDate', () async {
      ...
      expect(firstBuy, DateTime(2024, 1, 15), reason: 'must be the earliest valueDate (Jan 15), not the earliest operationDate (Mar 1)');
    });
