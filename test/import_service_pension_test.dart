...
//
// F1 — PPP: Italian Cometa, cash-only, 3 buckets, monthly + yearly snapshot.
...
//
// Truth: PPP year-end positions from import.tsv match the values in
// MoneyHistory.xlsx!PPP_FULL: 3224.07 / 13118.16 / 23836.43 / 35057.81
// / 46962.07 / 49555.72 (Feb-2026).
...
void main() {
  ...
  group('T3a — F1 (PPP) into single eventDriven asset', () {
    ...
    test('latest revalue.amount matches PPP_FULL year-end (49555.72)',
        () async {
      final assetId = await createPensionAsset();
      final capped = await importer.parseFile(
        'test/fixtures/ppp/import.tsv',
      ...
      // All six anchor revalues from PPP_FULL.
      final expected = <DateTime, double>{
        DateTime(2021, 12, 31): 3224.07,
        DateTime(2022, 12, 31): 13118.16,
        DateTime(2023, 12, 31): 23836.43,
        DateTime(2024, 12, 31): 35057.81,
        DateTime(2025, 12, 31): 46962.07,
        DateTime(2026, 2, 28): 49555.72,
      };
