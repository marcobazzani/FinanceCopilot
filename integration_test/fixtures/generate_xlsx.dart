...
void _createTransactionsSimple(String dir) {
  ...
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 15),
    DateCellValue(year: 2025, month: 1, day: 15),
    DoubleCellValue(-42.50),
    TextCellValue('Supermarket'),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 16),
    DateCellValue(year: 2025, month: 1, day: 16),
    DoubleCellValue(1500.00),
    TextCellValue('Salary'),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 17),
    DateCellValue(year: 2025, month: 1, day: 17),
    DoubleCellValue(-120.00),
    TextCellValue('Electricity'),
  ]);
...
void _createTransactionsFormula(String dir) {
  ...
  sheet.appendRow([
    DateCellValue(year: 2025, month: 2, day: 10),
    DateCellValue(year: 2025, month: 2, day: 10),
    DoubleCellValue(0),
    DoubleCellValue(2000.00),
    TextCellValue('Salary'),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 2, day: 12),
    DateCellValue(year: 2025, month: 2, day: 12),
  ...
  sheet.appendRow([
    DateCellValue(year: 2025, month: 2, day: 15),
    DateCellValue(year: 2025, month: 2, day: 15),
...
void _createTransactionsSkipRows(String dir) {
  ...
  sheet.appendRow([TextCellValue('Data_Operazione'), TextCellValue('Data_Valuta'), TextCellValue('Amount'), TextCellValue('Description')]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 3, day: 1),
    DateCellValue(year: 2025, month: 3, day: 1),
    DoubleCellValue(-80.00),
    TextCellValue('Insurance'),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 3, day: 5),
    DateCellValue(year: 2025, month: 3, day: 5),
    DoubleCellValue(3000.00),
    TextCellValue('Salary March'),
  ]);
...
void _createAssetsTypeColumn(String dir) {
  ...
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 10),
    TextCellValue('IE00B4L5Y983'),
    TextCellValue('Buy'),
    DoubleCellValue(10),
    DoubleCellValue(95.50),
    TextCellValue('EUR'),
    DoubleCellValue(960.00),
    DoubleCellValue(5.00),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 2, day: 15),
    TextCellValue('IE00B4L5Y983'),
    TextCellValue('Buy'),
    DoubleCellValue(5),
    DoubleCellValue(98.00),
    TextCellValue('EUR'),
    DoubleCellValue(495.00),
    DoubleCellValue(5.00),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 3, day: 1),
    ...
    TextCellValue('EUR'),
    DoubleCellValue(297.00),
    DoubleCellValue(3.00),
  ]);
...
void _createAssetsSignComputed(String dir) {
  ...
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 15),
    TextCellValue('LU0908500753'),
    DoubleCellValue(20),
    DoubleCellValue(210.50),
    TextCellValue('EUR'),
    DoubleCellValue(4220.00),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 3, day: 1),
    TextCellValue('LU0908500753'),
    DoubleCellValue(-5),
    DoubleCellValue(215.00),
    TextCellValue('EUR'),
    DoubleCellValue(1070.00),
  ]);
...
void _createAssetsMultiIsin(String dir) {
  ...
  sheet.appendRow([
    ...
    TextCellValue('EUR'),
    DoubleCellValue(950.00),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 10),
    TextCellValue('LU0908500753'),
    DoubleCellValue(20),
    DoubleCellValue(210.00),
    TextCellValue('EUR'),
    DoubleCellValue(4200.00),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 1, day: 10),
    TextCellValue('IE00BKM4GZ66'),
    DoubleCellValue(15),
    DoubleCellValue(32.00),
    TextCellValue('EUR'),
    DoubleCellValue(480.00),
  ]);
  sheet.appendRow([
    DateCellValue(year: 2025, month: 2, day: 10),
    TextCellValue('IE00B4L5Y983'),
    DoubleCellValue(5),
    DoubleCellValue(96.00),
    TextCellValue('EUR'),
    DoubleCellValue(480.00),
  ]);
  sheet.appendRow([
    ...
    TextCellValue('LU0908500753'),
    DoubleCellValue(10),
    DoubleCellValue(212.00),
    TextCellValue('EUR'),
    DoubleCellValue(2120.00),
  ]);
  ...
  for (var y = 2020; y <= 2025; y++) {
    for (var m = 1; m <= 12; m++) {
      ...
      row(
        ...
        descFull: 'Imposta di bollo del ${lastOfMonth.day.toString().padLeft(2, "0")}.${m.toString().padLeft(2, "0")}.$y',
...
void _createListaTitoliReal(String dir) {
  ...
  buy(op: DateTime(2020, 3, 5), val: DateTime(2020, 3, 9), titolo: 'ISHS CR WD USD-AC', isin: 'IE00B4L5Y983', qty: 25, price: 65.50);
  buy(op: DateTime(2020, 6, 12), val: DateTime(2020, 6, 16), titolo: 'LIF C S EU 600 UEAC', isin: 'LU0908500753', qty: 10, price: 175.20);
  buy(op: DateTime(2021, 4, 8), val: DateTime(2021, 4, 12), titolo: 'ISHS CR WD USD-AC', isin: 'IE00B4L5Y983', qty: 18, price: 82.10);
  buy(op: DateTime(2021, 9, 14), val: DateTime(2021, 9, 16), titolo: 'ISHS MSCI EM USD-AC', isin: 'IE00BKM4GZ66', qty: 40, price: 33.40);
  buy(op: DateTime(2022, 2, 22), val: DateTime(2022, 2, 24), titolo: 'XTR2 EUR OR SW 1CC', isin: 'LU0290358497', qty: 50, price: 132.80);
  buy(op: DateTime(2022, 11, 3), val: DateTime(2022, 11, 7), titolo: 'UBS COMPOS USD-A-AC', isin: 'IE00B53H0131', qty: 12, price: 95.40);
  buy(op: DateTime(2023, 5, 18), val: DateTime(2023, 5, 22), titolo: 'MUL L 1-3Y IG CC', isin: 'LU1650487413', qty: 8, price: 122.10);
  buy(op: DateTime(2023, 9, 1), val: DateTime(2023, 9, 5), titolo: 'ISHS CR WD USD-AC', isin: 'IE00B4L5Y983', qty: 12, price: 78.77);
  buy(op: DateTime(2024, 3, 15), val: DateTime(2024, 3, 19), titolo: 'XTR2 EUR OR SW 1CC', isin: 'LU0290358497', qty: 80, price: 138.50);
  buy(
    op: DateTime(2024, 7, 22),
    val: DateTime(2024, 7, 24),
    titolo: 'ISHS CR WD USD-AC',
    isin: 'IE00B4L5Y983',
    qty: 5,
    price: 95.00,
    sell: true,
  );
  buy(op: DateTime(2025, 2, 18), val: DateTime(2025, 2, 20), titolo: 'ISHS CR WD USD-AC', isin: 'IE00B4L5Y983', qty: 47, price: 108.69);
  buy(op: DateTime(2025, 5, 12), val: DateTime(2025, 5, 14), titolo: 'XTR2 EUR OR SW 1CC', isin: 'LU0290358497', qty: 100, price: 146.19);
  buy(op: DateTime(2025, 10, 13), val: DateTime(2025, 10, 15), titolo: 'XTR2 EUR OR SW 1CC', isin: 'LU0290358497', qty: 169, price: 147.43);
...
void _createRevolutReal(String dir) {
  ...
  buf.writeln('Tipo,Prodotto,Data di inizio,Data di completamento,Descrizione,Importo,Costo,Valuta,State,Saldo');
  ...
  void r(String tipo, DateTime d, String desc, double importo, double costo) {
    bal += importo - costo;
    final ts = '${d.year}-${d.month.toString().padLeft(2, "0")}-${d.day.toString().padLeft(2, "0")} 12:00:00';
    buf.writeln(
