...
class _CreateAssetDialogState extends State<_CreateAssetDialog> {
  ...
  void _selectResult(InvestingSearchResult result) {
    ...
    setState(() {
      ...
      _listings = exchangeListingsFor(_results, result);
    });
  }
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: IsinUrlPasteRecovery(
                      ...
                      cacheKey: _isinShaped(_searchCtrl.text.trim())
                          ? _searchCtrl.text.trim().toUpperCase()
                          : _searchCtrl.text.trim(),
                      defaultExchange: _selectedExchange ?? 'MIL',
                      onResolved: (result) {
        ...
        FilledButton(
          onPressed: _selectedIntermediaryId != null
              ? () async {
                  ...
                  final typed = _searchCtrl.text.trim().toUpperCase();
