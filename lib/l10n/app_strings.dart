...
class AppStrings {
  ...
  String get portfolioModelSearchResolveFailed =>
      _it ? 'Impossibile ricavare un ISIN valido dallo strumento selezionato.' : 'Could not resolve a valid ISIN for the selected instrument.';
  ...
  String get rebalanceUpdatingMarketData => _it ? 'Aggiornamento dati di mercato...' : 'Updating market data...';
  ...
  String get rebalanceApplyConfirmBody =>
      _it ? 'Verranno creati eventi asset per le righe proposte.' : 'Asset events will be created for the draft rows.';
  ...
  String get settingsImportWarningBody =>
      _it ? 'Tutti i dati attuali verranno sostituiti. Vuoi esportare prima?' : 'All current data will be replaced. Export first?';
  ...
  String get importExportBackupDriveHint => _it
      ? 'Carica il database corrente su Drive (sovrascrive il backup precedente)'
      : 'Upload current database to Drive (overwrites previous backup)';
  String get importExportRestoreDrive => _it ? 'Ripristina da Google Drive' : 'Restore from Google Drive';
  String get importExportRestoreDriveHint =>
      _it ? 'Sostituisci il database locale con il backup di Drive' : 'Replace local database with the Drive backup';
  String get importExportSignInFirst =>
  ...
  String get settingsWipeDbSubtitle =>
      _it ? 'Esporta e cancella tutti i dati. Irreversibile.' : 'Export and delete all data. This cannot be undone.';
  ...
  String get syncReauthNeeded =>
      _it ? 'Accedi di nuovo a Google Drive per continuare la sincronizzazione' : 'Please sign in to Google Drive again to continue syncing';
  ...
  String get chartCombineAutoAllHint =>
      _it ? 'La combinazione si aggiorna quando aggiungi o rimuovi grafici.' : 'The overlay updates as you add or remove charts.';
  ...
  String get recalcBalanceHelp =>
      _it ? 'Scegli come calcolare il saldo per ogni transazione.' : 'Choose how to compute balanceAfter for each transaction.';
  ...
  String get noTransactionsImport =>
      _it ? 'Nessuna transazione.\nImporta un file per aggiungere transazioni.' : 'No transactions yet.\nImport a file to add transactions.';
  ...
  String get balanceCumulativeHelp =>
      _it ? 'Saldo = somma progressiva degli importi dal più vecchio al più nuovo' : 'Balance = running sum of amount from oldest to newest';
  ...
  String get noAssetsYet =>
      _it ? 'Nessuna attività.\nImporta eventi attività per iniziare.' : 'No assets yet.\nImport asset events to get started.';
  ...
  String get instrumentNotFoundHeadline => _it ? 'Strumento non trovato' : 'Instrument not found';
  ...
  String get urlInvalidFormat =>
      _it ? 'Indirizzo non valido. Deve iniziare con http:// o https://.' : 'Invalid address. It must start with http:// or https://.';
  ...
  String flagAsAdjustmentBody(String amount) =>
  ...
  String get noIntermediariesAvailable => _it ? 'Nessun intermediario; creane uno prima' : 'No intermediaries; create one first';
  String get signBasedHelp =>
      _it ? 'Quantità o importo negativo = Vendita, positivo = Acquisto' : 'Negative quantity or amount = Sell, positive = Buy';
  String get signBasedNegativeIsBuyLabel => _it ? 'Acquisti con segno negativo (flusso di cassa)' : 'Buys are negative (cash-flow convention)';
  String get computedLabel => _it ? 'Calcolato' : 'Computed';
  String get buySellAllRequired =>
      _it ? 'Ogni valore deve essere assegnato a Acquisto, Vendita o Commissione' : 'Every value must be assigned to Buy, Sell, or Fee';
  ...
  String get ticketerUploadReminder =>
      _it ? 'Apri la cartella, poi trascina i file nella segnalazione GitHub.' : 'Open the folder, then drag the files into the GitHub issue.';
  ...
  String get ticketerScreenshotBanner =>
      _it ? 'Questo screenshot deve essere caricato nella segnalazione GitHub' : 'This screenshot must be uploaded to the GitHub issue';
